...
aws ssm put-parameter \
    ...
    --type "String" \
    --value "aws_codepipeline-demo"

aws ssm put-parameter \
    --name "/service/aws-sam-hello-pipeline/github/token" \
    --description "Github Token for Cloudformation Stack aws-sam-hello-pipeline-pipeline" \
    --type "String" \
    --value ""

aws ssm put-parameter \
    --name "/service/aws-sam-hello-pipeline/github/user" \
...
aws cloudformation create-stack \
    --stack-name aws-sam-hello-pipeline-pipeline \
